...
High Voltage will generate a named route method of `page_path` which you can use
in your views `page_path('about')`. If you want to generate a named route (with the :as routing option) for some route which will be handled
